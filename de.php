			...
			<li>Lunes
            	<div data-role="collapsible">
                        	...
                        	<div class="ui-grid-a">
                        	  ...
                        	  <?php
								$query = 'SELECT * FROM tutorias WHERE curso="de" AND dia="lunes" AND ano=2';
            ...
            <li>Jueves
            	<div data-role="collapsible">
                            ...
                            <div class="ui-grid-a">
                        	  ...
                        	  <div class="ui-block-b">Horas | Aulas</div>  
                              <?php
								$query = 'SELECT * FROM tutorias WHERE curso="de" AND dia="jueves" AND ano=1';
								$result = mysql_query($query) or die('Consulta 	fallida: ' . mysql_error());	
								while ($line = mysql_fetch_array($result)){
									echo "<div class='ui-block-a'>".$line[3]."</div>";
									echo "<div class='ui-block-b'>".$line[4]." | ".$line[5]."</div>";
                        ...
                        <div data-role="collapsible">
                            ...
                            <div class="ui-grid-a">
                        	  ...
                        	  <div class="ui-block-b">Horas | Aulas</div>  
                              <?php
								$query = 'SELECT * FROM tutorias WHERE curso="de" AND dia="jueves" AND ano=2';
								$result = mysql_query($query) or die('Consulta 	fallida: ' . mysql_error());	
								while ($line = mysql_fetch_array($result)){
									echo "<div class='ui-block-a'>".$line[3]."</div>";
									echo "<div class='ui-block-b'>".$line[4]." | ".$line[5]."</div>";
