			...
			<li>Martes
            	<div data-role="collapsible">
                        	...
                        	<div class="ui-grid-a">
                        	  ...
                        	  <?php
								$query = 'SELECT * FROM tutorias WHERE curso="geh" AND dia="martes" AND ano=1';
            ...
            <li>Miércoles
            	<div data-role="collapsible">
                            ...
                            <div class="ui-grid-a">
                        	  ...
                        	  <div class="ui-block-b">Horas | Aulas</div>                            
                        	  <?php
								$query = 'SELECT * FROM tutorias WHERE curso="geh" AND dia="miercoles" AND ano=1';
								$result = mysql_query($query) or die('Consulta 	fallida: ' . mysql_error());	
								while ($line = mysql_fetch_array($result)){
									echo "<div class='ui-block-a'>".$line[3]."</div>";
									echo "<div class='ui-block-b'>".$line[4]." | ".$line[5]."</div>";
